...
ALIGN	32
__mulq_mont_384__sub_mod_384x384	PROC PRIVATE
	DB	243,15,30,250
	...
	DB	0F3h,0C3h		;repret
__mulq_mont_384__sub_mod_384x384	ENDP


ALIGN	32
__mulq_mont_384__add_mod_384	PROC PRIVATE
	DB	243,15,30,250
	mov	r8,QWORD PTR[rsi]
	mov	r9,QWORD PTR[8+rsi]
	mov	r10,QWORD PTR[16+rsi]
	...
	DB	0F3h,0C3h		;repret
__mulq_mont_384__add_mod_384	ENDP


ALIGN	32
__mulq_mont_384__sub_mod_384	PROC PRIVATE
	DB	243,15,30,250
	mov	r8,QWORD PTR[rsi]
	mov	r9,QWORD PTR[8+rsi]
	mov	r10,QWORD PTR[16+rsi]
...
__mulq_mont_384__sub_mod_384_a_is_loaded::
	...
	DB	0F3h,0C3h		;repret
__mulq_mont_384__sub_mod_384	ENDP
...
ALIGN	32
__mulq_mont_384__mulq_384	PROC PRIVATE
	DB	243,15,30,250
	...
	DB	0F3h,0C3h		;repret
__mulq_mont_384__mulq_384	ENDP
PUBLIC	sqr_384
...
ALIGN	32
__mulq_mont_384__sqrq_384	PROC PRIVATE
	DB	243,15,30,250
	...
	DB	0F3h,0C3h		;repret
__mulq_mont_384__sqrq_384	ENDP
...
ALIGN	32
__mulq_mont_384__mulq_by_1_mont_384	PROC PRIVATE
	DB	243,15,30,250
	mov	rax,QWORD PTR[rsi]
	mov	r9,QWORD PTR[8+rsi]
	mov	r10,QWORD PTR[16+rsi]
	...
	mov	r11,rdx
	DB	0F3h,0C3h		;repret
__mulq_mont_384__mulq_by_1_mont_384	ENDP


ALIGN	32
__mulq_mont_384__redc_tail_mont_384	PROC PRIVATE
	DB	243,15,30,250
	add	r14,QWORD PTR[48+rsi]
	mov	rax,r14
	adc	r15,QWORD PTR[56+rsi]
	...
	DB	0F3h,0C3h		;repret
__mulq_mont_384__redc_tail_mont_384	ENDP
...
ALIGN	32
__mulq_mont_384__mulq_mont_384	PROC PRIVATE
	DB	243,15,30,250
	mov	rdi,rax
	mul	r14
	mov	r8,rax
	...
	DB	0F3h,0C3h		;repret
__mulq_mont_384__mulq_mont_384	ENDP
...
ALIGN	32
__mulq_mont_384__mulq_mont_383_nonred	PROC PRIVATE
	DB	243,15,30,250
	mov	rbp,rax
	mul	r14
	mov	r8,rax
	...
	adc	r11,rdx
	DB	0F3h,0C3h		;repret
__mulq_mont_384__mulq_mont_383_nonred	ENDP
