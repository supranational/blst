...
ALIGN	32
__ctq_inverse_mod_384__smulq_767x63	PROC PRIVATE
	DB	243,15,30,250
	mov	r8,QWORD PTR[rsi]
	mov	r9,QWORD PTR[8+rsi]
	mov	r10,QWORD PTR[16+rsi]
	...
	DB	0F3h,0C3h		;repret
__ctq_inverse_mod_384__smulq_767x63	ENDP

ALIGN	32
__ctq_inverse_mod_384__smulq_383x63	PROC PRIVATE
	DB	243,15,30,250
	mov	r8,QWORD PTR[rsi]
	mov	r9,QWORD PTR[8+rsi]
	mov	r10,QWORD PTR[16+rsi]
	...
	DB	0F3h,0C3h		;repret
__ctq_inverse_mod_384__smulq_383x63	ENDP

ALIGN	32
__ctq_inverse_mod_384__smulq_383_n_shift_by_62	PROC PRIVATE
	DB	243,15,30,250
	mov	rbx,rdx
	mov	r8,QWORD PTR[rsi]
	mov	r9,QWORD PTR[8+rsi]
	...
	DB	0F3h,0C3h		;repret
__ctq_inverse_mod_384__smulq_383_n_shift_by_62	ENDP

ALIGN	32
__ctq_inverse_mod_384__ab_approximation_62	PROC PRIVATE
	DB	243,15,30,250
	...
	DB	0F3h,0C3h		;repret
__ctq_inverse_mod_384__ab_approximation_62	ENDP

ALIGN	8
	DD	0
__ctq_inverse_mod_384__inner_loop_62	PROC PRIVATE
	DB	243,15,30,250
	mov	rdx,1
	xor	rcx,rcx
	xor	r12,r12
...
.__ctq_inverse_mod_384__Loop_62::
	...
	DB	0F3h,0C3h		;repret
__ctq_inverse_mod_384__inner_loop_62	ENDP
.text$	ENDS
