...
.type	__${pre}__sub_mod_384x384,\@abi-omnipotent
.align	32
__${pre}__sub_mod_384x384:
	mov	8*0($a_ptr), @acc[0]
	mov	8*1($a_ptr), @acc[1]
	mov	8*2($a_ptr), @acc[2]
	mov	8*3($a_ptr), @acc[3]
	...
	ret
.size	__${pre}__sub_mod_384x384,.-__${pre}__sub_mod_384x384

.type	__${pre}__add_mod_384,\@abi-omnipotent
.align	32
__${pre}__add_mod_384:
	mov	8*0($a_ptr), @acc[0]
	mov	8*1($a_ptr), @acc[1]
	mov	8*2($a_ptr), @acc[2]
	mov	8*3($a_ptr), @acc[3]
	...
	ret
.size	__${pre}__add_mod_384,.-__${pre}__add_mod_384

.type	__${pre}__sub_mod_384,\@abi-omnipotent
.align	32
__${pre}__sub_mod_384:
	mov	8*0($a_ptr), @acc[0]
	mov	8*1($a_ptr), @acc[1]
	mov	8*2($a_ptr), @acc[2]
	mov	8*3($a_ptr), @acc[3]
...
__${pre}__sub_mod_384_a_is_loaded:
	sub	8*0($b_org), @acc[0]
	 mov	8*0($n_ptr), @acc[6]
	sbb	8*1($b_org), @acc[1]
	 mov	8*1($n_ptr), @acc[7]
	...
	ret
.size	__${pre}__sub_mod_384,.-__${pre}__sub_mod_384
___
}
...
.cfi_end_prologue
	...
	lea	40(%rsp), $b_org	# t0
	mov	8*1(%rsp), $n_ptr
	call	__${pre}__sub_mod_384x384	# t2=t2-t0

	lea	($r_ptr), $a_ptr	# t2
	lea	-96($r_ptr), $b_org	# t1
	call	__${pre}__sub_mod_384x384	# t2=t2-t1

	################################# t0=t0-t1
	lea	40(%rsp), $a_ptr
	lea	40+96(%rsp), $b_org
	lea	40(%rsp), $r_ptr
	call	__${pre}__sub_mod_384x384	# t0-t1
	...
	call	__${pre}__mulq_by_1_mont_384
	call	__${pre}__redc_tail_mont_384
...
.cfi_end_prologue
	...
	mov	$r_ptr, 8*1(%rsp)	# to __${pre}__mulq_mont_384
	mov	$a_ptr, 8*2(%rsp)
	...
	call	__${pre}__mulq_mont_384
___
{
my @acc = map("%r$_",14,15,8..11,	# output from __${pre}__mulq_mont_384
                     12,13,"ax","bx","bp","si");
$code.=<<___;
...
.cfi_end_prologue
	...
	lea	48($a_ptr), $b_org
	lea	48($r_ptr), $r_ptr
	call	__${pre}__sub_mod_384_a_is_loaded
...
.type	__${pre}__mulq_384,\@abi-omnipotent
.align	32
__${pre}__mulq_384:
	mov	8*0($b_ptr), %rax
...
$code.=<<___;
	...
	ret
.size	__${pre}__mulq_384,.-__${pre}__mulq_384
___
}
if (0) { ##############################################################
my @b=map("%r$_",(10..15));
...
$code.=<<___;
.type	__${pre}__mulq_comba_384,\@abi-omnipotent
.align	32
__${pre}__mulq_comba_384:
	mov	8*0($b_ptr), %rax
	mov	8*0($a_ptr), @a[0]
	mov	8*1($a_ptr), @a[1]
	mov	8*1($b_ptr), @b[1]
...
$code.=<<___;
	...
	ret
.size	__${pre}__mulq_comba_384,.-__${pre}__mulq_comba_384
___
}
{ ########################################################## 384-bit sqr
...
.type	__${pre}__sqrq_384,\@abi-omnipotent
.align	32
__${pre}__sqrq_384:
	mov	8*0($a_ptr), %rax
	mov	8*1($a_ptr), @acc[7]
...
$code.=<<___;
	...
	ret
.size	__${pre}__sqrq_384,.-__${pre}__sqrq_384
...
.cfi_end_prologue
	...
	#mov	@acc[6], %rax		# __${pre}__mulq_by_1_mont_384 does it
	mov	@acc[7], %rcx
	mov	@acc[0], %rdx
	mov	@acc[1], %rbp
...
$code.=<<___;
.type	__${pre}__mulq_by_1_mont_384,\@abi-omnipotent
.align	32
__${pre}__mulq_by_1_mont_384:
	mov	8*0($a_ptr), %rax
	mov	8*1($a_ptr), @acc[1]
	mov	8*2($a_ptr), @acc[2]
	mov	8*3($a_ptr), @acc[3]
...
$code.=<<___;
	ret
.size	__${pre}__mulq_by_1_mont_384,.-__${pre}__mulq_by_1_mont_384

.type	__${pre}__redc_tail_mont_384,\@abi-omnipotent
.align	32
__${pre}__redc_tail_mont_384:
	...
	ret
.size	__${pre}__redc_tail_mont_384,.-__${pre}__redc_tail_mont_384
...
$code.=<<___;
.type	__${pre}__mulq_mont_384,\@abi-omnipotent
.align	32
__${pre}__mulq_mont_384:
	mov	%rax, $bi
	mulq	@acc[6]			# a[0]*b[0]
	mov	%rax, @acc[0]
	mov	$bi, %rax
...
$code.=<<___;
	...
	ret
.size	__${pre}__mulq_mont_384,.-__${pre}__mulq_mont_384
___
} }
$code.=<<___;
...
.Loop_sqr_383:
	...
	call	__${pre}__mulq_mont_384		# formally one can omit full reduction
...
$code.=<<___;
.type	__${pre}__mulq_mont_383_nonred,\@abi-omnipotent
.align	32
__${pre}__mulq_mont_383_nonred:
	mov	%rax, $bi
	mulq	@acc[6]			# a[0]*b[0]
	mov	%rax, @acc[0]
	mov	$bi, %rax
...
$code.=<<___;
	ret
.size	__${pre}__mulq_mont_383_nonred,.-__${pre}__mulq_mont_383_nonred
___
}
{ my $frame = 4*8 +	# place for argument off-load +
	      2*384/8 +	# place for 2 384-bit temporary vectors
...
.cfi_end_prologue
	...
	mov	8*3(%rsp), $r_ptr
	call	__${pre}__mulq_mont_383_nonred
___
{
my @acc = map("%r$_",14,15,8..11,	# output from __${pre}__mulq_mont_384
                     12,13,"ax","bx","bp","si");
